...
for agent in range(NN):
    ...
    plt.loglog(range(epochs-1), (JJ[:-1, agent]))
...
plt.loglog(range(epochs-1), temp_sum_JJ[:-1])
...
for agent in range(NN):
    ...
    plt.loglog(range(epochs-1), temp_norm[:-1])
...
plt.loglog(range(epochs-1), temp_sum_norm[:-1])
